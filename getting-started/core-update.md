...
>또한, XE 3.0.0-rc.8 버전에서는 deprecated 코드가 삭제되었습니다. 코어 업데이트 전에 플러그인 업데이트 및 개별 제작 사용된 플러그인에 관련코드를 수정하시기 바랍니다.    

>XE 3.0.0 버전 업데이트에서는 migration update 코드가 삭제되었습니다. 3.0.0 으로 업데이트 하기전에 rc.8 버전으로 업데이트를 수행하신 후 3.0.0 으로 업데이트 하시기 바랍니다.
