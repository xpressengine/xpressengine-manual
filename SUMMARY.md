...
* [사이트 설정](core-setupindex/member-management.md)
  ...
  * [관리자 패스워드 설정](core-setupindex/administrator-password.md)
...
* [익스텐션 제작 가이드](extension-make-guide/start-make-extension.md)
  * [제작 시작하기](extension-make-guide/start-make-extension.md)
  * [버전 관리](extension-make-guide/branch_and_version.md)
  * [관리자 사이트 메뉴 추가 방법](extension-make-guide/admin-site-menu-extend.md)
  * [컴포넌트 추가 방법](extension-make-guide/how-to-add-component.md)
  * [개인설정 페이지 추가](extension-make-guide/personal-setting-page.md)
  * [회원가입 입력폼 추가](extension-make-guide/member-signin-form.md)
  * [다국어 지원](extension-make-guide/language-add.md)
